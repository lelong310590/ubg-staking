...
export class StakingService {
  static async calculateReward(amount: number, days: number) {
    ...
    }, NumberUtils.cryptoConvert('encode', amount, SmcService.contractUBGToken._decimals), days)
      .then(res => +NumberUtils.cryptoConvert('decode', +res, SmcService.contractUBGToken._decimals))
  }
